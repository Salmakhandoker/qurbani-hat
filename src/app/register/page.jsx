    ...
    <div className="min-h-[85vh] bg-slate-50 flex items-center justify-center py-16 px-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl border border-slate-100 p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 text-sm">Join QurbaniHat to explore and book livestock</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="form-control">
            ...
            <input
              type="text"
              placeholder="e.g. Salma Khandoker"
              value={name}
        ...
        {/* Divider */}
        <div className="divider text-xs text-slate-400 font-semibold uppercase">Or signup with</div>
